...
public interface BoardMapper {
	...
	// 글 목록을 가지고 오는 메서드
	// 원래 Sql "SELECT * FROM toon_board WHERE bd_email !='root@naver.com' ORDER BY bd_num DESC LIMIT ?,?;
	...
	//원래 sql문 "select * from toon_board where bd_email ='".concat(email) + "' order by bd_num DESC;"
	...
	// 글 검색 요청을 처리할 메서드
	// SELECT * FROM toon_board WHERE bd_title LIKE ? AND bd_email !='root@naver.com'
	// 
	...
	@Update("UPDATE toon_board SET bd_view=${bView} WHERE bd_num=${bId}")
