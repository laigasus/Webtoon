...
public interface WebtoonMapper {
	...
	public void insertWebtoonList(@Param("id") String id,@Param("thumb") String thumb,
			@Param("title") String title, @Param("url") String url,@Param("day") String day);
	...
	public void myWebtoonDelete(@Param("webtoonTitle") String webtoonTitle,@Param("login") String login); // mt_title 이랑 mt_user 로 구분해서 삭제
