...
<body>
	...
	<header>
		<div class="container">
			커뮤니티<img src="${path}/resources/img/menu/jajak-upload.svg" />
		</div>
	</header>
	<section>
		<div class="container">
			...
			<form action="/jajak_comment_control" method="post">
				<input type="hidden" name="bd_num" value="${bd_num}"> <input
					type="hidden" name="nick" value="${nick}"><br>
				<h1 id="comment-h1">
					<img src="${path}/resources/img/button/arrow.svg" /> 댓글
				</h1>
				<br>
				<table style="text-align: center;">
					<c:choose>
						<c:when test="${commentEmpty==true}">
							<thead>
								<tr>
									<th width="50%">
								<tr>
								...
								<tr>
									<th><img src="${path}/resources/img/zzz.svg"></th>
								</tr>
							</thead>
						</c:when>
						<c:otherwise>
							...
							<tbody>
								<c:choose>
									<c:when test="${best eq best}">
										<tr style="background-color: #ffe2f4;">
											...
											<td width="5%">${best.getCm_like()}<a
												href="/comment_like_control?bd_num=${bd_num}&cm_id=${best.getCm_id()}&writer=${writer}">
													<img src="${path}/resources/img/love.svg">
											</a></td>
										</tr>
									</c:when>
								</c:choose>
								<c:forEach items="${comments}" var="comment">
									<tr>
										...
										<td width="5%">${comment.getCm_like()}<a
											href="/comment_like_control?bd_num=${bd_num}&cm_id=${comment.getCm_id()}&writer=${writer}">
												<img src="${path}/resources/img/love.svg">
										</a></td>
									</tr>
								</c:forEach>
					...
					<tfoot>
						<tr>
							...
							<td><textarea style="resize: none; text-area: left;"
									name="cm_content" rows="4" cols="70"></textarea></td>
							<td style="text-align: center;"><input
								id="jajak-input-button" type="submit" value="등록"></td>
						</tr>
					</tfoot>
				</table>
			</form>
