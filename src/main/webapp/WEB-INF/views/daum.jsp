...
<body>
	...
	<header>
		<div class="container">
			다음<br>웹툰<img src="${path}/resources/img/menu/site.svg" />
		</div>
	</header>
	<section>
		<div class="container">
			<h1>
				<img src="${path}/resources/img/button/arrow.svg" /> 다음 웹툰
			</h1>
			<ul id="day-tab">
				<li><a>월</a><img src="${path}/resources/img/day/mon.svg" /></li>
				<li class="active"><a>화</a><img
					src="${path}/resources/img/day/tue.svg" /></li>
