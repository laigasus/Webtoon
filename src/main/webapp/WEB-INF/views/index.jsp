...
<body>
	...
	<header>
		<div class="container">
			오늘의<br>웹툰<img src="${path}/resources/img/menu/today.svg" />
		</div>
	</header>
	<section>
		<div class="container">
			<div id="slide-1">
				<button class="left">
					<img src="${path}/resources/img/button/slider/back.svg" />
				</button>
			...
			<h1>
				<img src="${path}/resources/img/button/arrow.svg" /> 오늘 랭킹 TOP 10
			</h1>
			<div class="list-container">
				<a href="detail.jsp"> <img
					src="${path}/resources/img/toons/revatoon.jpg" />
					<ul>
						<li class="title">레바툰<span class="badge">UP</span></li>
						<li class="genre">개그 / 일상</li>
						<li class="author">레바</li>
					</ul>
				</a> <a href="detail.jsp"> <img
					src="${path}/resources/img/toons/shingi.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/cartoon_hero.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/gowrong.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/art_of_loving.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/SuicideCat.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/thewizard.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/ccromance.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/bananatoon.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/lovebarometer.jpg" />
					<ul>
			...
			<h1>
				<img src="${path}/resources/img/button/arrow.svg" /> 웹툰 기다리면 무료
			</h1>
			<div class="list-container">
				<a href="detail.jsp"> <img
					src="${path}/resources/img/toons/woori.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/unknown_code.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/nadu.jpg" />
					<ul>
						<li class="title">낭만두더지 나두<span class="badge">UP</span>
						</li>
						<li class="genre">로맨스</li>
						<li class="author">크레이지버드 스튜디오</li>
					</ul>
				</a> <a href="detail.jsp"> <img
					src="${path}/resources/img/toons/mycatsir.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/do_family.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/double_casting.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/horns.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/neo_magnet.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/m_street_no9.jpg" />
					<ul>
					...
					src="${path}/resources/img/toons/white_epic.jpg" />
					<ul>
