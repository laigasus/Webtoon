...
<html>
  ...
  <body>
    ...
    <header>
      <div class="container">오늘의<br>웹툰<img src="img/menu/today.svg"/></div>
    </header>
    <section>
      <div class="container">
        <div id="slide-1">
          <button class="left"><img src="img/button/slider/back.svg"/></button>
        ...
        <h1><img src="img/button/arrow.svg" /> 오늘 랭킹 TOP 10</h1>
        <div class="list-container">
          <a href="detail.jsp">
            <img src="img/toons/revatoon.jpg" />
            <ul>
          ...
          <a href="detail.jsp">
            <img src="img/toons/cartoon_hero.jpg" />
            <ul>
          ...
          <a href="detail.jsp">
            <img src="img/toons/art_of_loving.jpg" />
            <ul>
        ...
        <h1><img src="img/button/arrow.svg" /> 웹툰 기다리면 무료</h1>
        <div class="list-container">
          <a href="detail.jsp">
